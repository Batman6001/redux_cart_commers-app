        ...
        <>
            <div className="main-container-blog">
                ...
                <div class="cart-container">
                    ...
                    <div class="cart-item">
                        <img src="//www.flatheads.in/cdn/shop/articles/Kooltex_blog_banner_1024x417.jpg?v=1646314778" alt="5" />
                        <p className='cart-item-content1'> What’s cool about KoolTex? An explainer on Dry Fit trainers.</p>
                        <p className='cart-item-content2'>March 03, 2022</p>
                        <p className='cart-item-content3'>Perhaps the most important criteria when selecting footwear is how good it makes you feel. When you’re on your feet all day long, it only makes sense to invest in footwear that helps you...</p>
                        <u> <h6>CONTINUE READING</h6></u>
                    </div>
                    <div class="cart-item">
                        <img src="//www.flatheads.in/cdn/shop/articles/Bana_1024x417.jpg?v=1645967955" alt="Here" />
                        <p className='cart-item-content1'>Bet you’ve never seen a shoe like this: Meet the world’s first Banana Kicks.</p>
                        <p className='cart-item-content2'>February 27, 2022</p>
                        <p className='cart-item-content3'>What’s the deal, banana peel?
                            Not sure about peels but banana stems sure are a big deal for us. Read more to find out why.
                            ...</p>
                        <u> <h6>CONTINUE READING</h6></u>
                    </div>
                    <div class="cart-item">
                        <img src="//www.flatheads.in/cdn/shop/articles/Blog_banner2_1024x417.jpg?v=1645781853" alt="Here" />
                        <p className='cart-item-content1'>Launching not one but four, ‘first-of-its-kind’ collections!</p>
                        <p className='cart-item-content2'>February 24, 2022</p>
                        <p className='cart-item-content3'>Those who have followed our journey already know how obsessed we are with breaking the rules. So it should come as no surprise that we did it again. We identified new materials and...</p>
                        <u> <h6>CONTINUE READING</h6></u>
                    </div>
                    ...
                    <div class="cart-item">
                        <img src="//www.flatheads.in/cdn/shop/articles/Cover_Image_We_re_on_a_mission_1024x768.jpg?v=1644212916" alt="5" />
                        <p className='cart-item-content1'> What’s cool about KoolTex? An explainer on Dry Fit trainers.</p>
                        <p className='cart-item-content2'>March 03, 2022</p>
                        <p className='cart-item-content3'>Perhaps the most important criteria when selecting footwear is how good it makes you feel. When you’re on your feet all day long, it only makes sense to invest in footwear that helps you...</p>
                        <u> <h6>CONTINUE READING</h6></u>
                    ...
                    <div class="cart-item">
                        <img  src="//www.flatheads.in/cdn/shop/articles/Blog3_1024x320.jpg?v=1629448534" alt="Here" />
                        <p className='cart-item-content1'>Bet you’ve never seen a shoe like this: Meet the world’s first Banana Kicks.</p>
                        <p className='cart-item-content2'>February 27, 2022</p>
                        <p className='cart-item-content3'>What’s the deal, banana peel?
                            Not sure about peels but banana stems sure are a big deal for us. Read more to find out why.
                    ...
                    <div class="cart-item">
                        <img src="//www.flatheads.in/cdn/shop/articles/blog_2_creative-01-optimised_1024x768.jpg?v=1624590245" alt="Here" />
                        <p className='cart-item-content1'>Launching not one but four, ‘first-of-its-kind’ collections!</p>
                        <p className='cart-item-content2'>February 24, 2022</p>
                        <p className='cart-item-content3'>Those who have followed our journey already know how obsessed we are with breaking the rules. So it should come as no surprise that we did it again. We identified new materials and...</p>
                        <u> <h6>CONTINUE READING</h6></u>
                    ...
                    <div class="cart-item">
                        <img src="//www.flatheads.in/cdn/shop/articles/blog_1-01_-_1200_900-optimised_1024x768.jpg?v=1622684422" alt="Here" />
                        <p className='cart-item-content1'>Launching not one but four, ‘first-of-its-kind’ collections!</p>
                        <p className='cart-item-content2'>February 24, 2022</p>
                        <p className='cart-item-content3'>Those who have followed our journey already know how obsessed we are with breaking the rules. So it should come as no surprise that we did it again. We identified new materials and...</p>
                        <u> <h6>CONTINUE READING</h6></u>
